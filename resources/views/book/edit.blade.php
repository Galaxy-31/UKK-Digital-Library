                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="title" id="judul"
                            ...
                            placeholder="" required value="{{ $book->title }}">
                        @error('slug')
                    ...
                    <div>
                        ...
                        <input type="text" name="penulis" id="penulis"
                            ...
                            @else
                                dark:border-gray-300 @endif
                            text-gray-900 sm:text-sm rounded-lg focus:outline-none focus:ring-offset-1 focus:ring-2 focus:ring-blue-500 focus:border-white block w-full p-2.5"
                            placeholder="" required value="{{ $book->penulis }}">
                        @error('penulis')
                            <p class="mt-1 text-left text-sm text-red-600 mb-0">
                                {{ $message }}
                            </p>
                    ...
                    <div>
                        ...
                        <input type="text" name="penerbit" id="penerbit"
                            ...
                            @else
                                dark:border-gray-300 @endif
                            text-gray-900 sm:text-sm rounded-lg focus:outline-none focus:ring-offset-1 focus:ring-2 focus:ring-blue-500 focus:border-white block w-full p-2.5"
                            placeholder="" required value="{{ $book->penerbit }}">
                        @error('penerbit')
                            <p class="mt-1 text-left text-sm text-red-600 mb-0">
                                {{ $message }}
                            </p>
                    ...
                    <div>
                        ...
                        <input type="number" min="0" name="stok" id="Jumlah Buku"
                            ...
                            @else
                                dark:border-gray-300 @endif
                            text-gray-900 sm:text-sm rounded-lg focus:outline-none focus:ring-offset-1 focus:ring-2 focus:ring-blue-500 focus:border-white block w-full p-2.5"
                            placeholder="" min="0" value="{{ $book->stok }}">
                        @error('stok')
                            <p class="mt-1 text-left text-sm text-red-600 mb-0">
                                {{ $message }}
                            </p>
                        ...
                        <select name="category_id" id="category"
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}"
                                    @if ($category->id == $book->category_id) @selected(true) @endif>
                    ...
                    <div>
                        ...
                        <input type="date" name="thn_terbit" id="thn_terbit"
                            ...
                            @else
                                dark:border-gray-300 @endif
                            text-gray-900 sm:text-sm rounded-lg focus:outline-none focus:ring-offset-1 focus:ring-2 focus:ring-blue-500 focus:border-white block w-full p-2.5"
                            placeholder="" required value="{{ $book->thn_terbit }}">
                        @error('thn_terbit')
                            <p class="mt-1 text-left text-sm text-red-600 mb-0">
                                {{ $message }}
                            </p>
                    ...
                    <div class="w-full">
                        <div>
                            ...
                            <input type="number" min="0" name="kode_buku" id="kodebuku"
                    ...
                    <label class="block">
                        ...
                        @enderror
                        <img id="file-ip-1-preview" class="rounded-lg mt-3" src="{{ asset('storage/public' . $book->image) }}">
                    </label>
                </div>
