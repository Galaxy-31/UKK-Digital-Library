            ...
            @foreach ($books as $book)
                <a href="{{ route('books.show', $book->slug) }}"
                    ...
                    <div class="sortable">
                        ...
                        @endif
                        @endif
                        <img src="{{ asset('storage/' . $book->image) }}" alt="Foto" class="w-full h-96 object-cover rounded">
                    </div>
    ...
    <div class="p-4">
        ...
        <div class="mt-6">
            <div class="overflow-auto rounded-lg shadow block w-full mt-5 md:mt-0 md:col-span-2">
                ...
                <table class="sortable,table-auto w-full">
                    <thead class="bg-gray-50 border-b-2 border-gray-200,sortable">
                        <tr>
                            <script src="https://www.kryogenix.org/code/browser/sorttable/sorttable.js"></script>
                            <th class="w-10 p-3 text-sm font-semibold tracking-wide text-left">No</th>
                            <th class="w-32 p-3 text-sm font-semibold tracking-wide text-left">Judul Buku</th>
