                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-start">
                                    <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <img src="{{ asset('/assets/my-logo.png') }}" width="45" alt="logo">
                                        <span class="font-bold text-xl tracking-wide ml-3 text-black">WikBook</span>
                                    </a>
                                    <p class="mb-0" class align="center">Digital Library Wikrama</p>
                                </div>
                                <div class="card-body">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                ...
                                <p class="text-white position-relative">Perpustakaan Digital adalah koleksi data multimedia dalam skala besar yang terorganisasi dengan perangkat manajemen informasi dan metode yang mampu menampilakan data sebagai informasi dan pengetahuan yang berguna bagi masyarakat dalam berbagai konteks organisasi dan sosial masyarakat.</p>
                            </div>
                        </div>
                    </div>
                </div>
